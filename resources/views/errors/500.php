...
<body class="d-flex align-items-center justify-content-center min-vh-100 bg-light">
    <div class="text-center p-4" style="max-width: 480px;">
        <div class="display-1 fw-800 text-secondary mb-2">500</div>
        <h2 class="fw-700 mb-3">Something Went Wrong</h2>
        <p class="text-muted mb-4">An internal error occurred. Our team has been notified and is looking into the issue.</p>

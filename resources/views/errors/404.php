...
<body class="d-flex align-items-center justify-content-center min-vh-100 bg-light">
    <div class="text-center p-4" style="max-width: 480px;">
        <div class="display-1 fw-800 text-primary mb-2">404</div>
        <h2 class="fw-700 mb-3">Page Not Found</h2>
        <p class="text-muted mb-4">The page or resource you are looking for might have been removed, had its name changed, or is temporarily unavailable.</p>
